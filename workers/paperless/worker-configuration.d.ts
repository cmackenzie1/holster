/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 301729fa780c6aea219b82c33e534462)
// Runtime types generated with workerd@1.20260128.0 2025-09-02 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/server");
		durableNamespaces: "TikaContainer";
	}
	interface Env {
		R2: R2Bucket;
		HYPERDRIVE: Hyperdrive;
		EMAIL: SendEmail;
		DOCUMENT_PROCESS_QUEUE: Queue<import("./src/queue/types").DocumentProcessMessage>;
		AI: Ai;
		CF_VERSION_METADATA: WorkerVersionMetadata;
		ALLOWED_EMAIL_SENDERS: "";
		TIKA_CONTAINER: DurableObjectNamespace<import("./src/server").TikaContainer>;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ALLOWED_EMAIL_SENDERS">> {}
}
