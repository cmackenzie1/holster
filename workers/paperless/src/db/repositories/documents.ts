import { eq, and, or, isNull, isNotNull, desc, inArray, lt, ilike } from "drizzle-orm";
...
export async function listDocuments(
  db: Database,
  options: { filterTagIds?: string[]; limit?: number; cursor?: string; search?: string } = {}
...
export async function updateDocument(
  db: Database,
  id: bigint,
  updates: { title?: string; content?: string | null; archiveSerialNumber?: number | null }
): Promise<boolean> {
