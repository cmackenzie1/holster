...
const AUDIENCE = "c9ed339848e406c48d16ecb95e38ff69ec7e36045b0bba7ad97a1dc0a5d4d5ee";
 ...
 */
function parseJWT(token: string): { header: JWTHeader; payload: JWTPayload; signature: Uint8Array; signedData: string } {
 ...
 */
async function verifySignature(signedData: string, signature: Uint8Array, key: CryptoKey): Promise<boolean> {
 ...
 */
export async function verifyCloudflareAccess(request: Request): Promise<VerifyResult> {
  try {
